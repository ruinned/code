...
**
**     Contents  :
**         Enable            - byte CAN0_Enable(void);
**         Disable           - byte CAN0_Disable(void);
**         EnableEvent       - byte CAN0_EnableEvent(void);
**         DisableEvent      - byte CAN0_DisableEvent(void);
**         SetAcceptanceCode - byte CAN0_SetAcceptanceCode(dword AccCode1, dword AccCode2);
**         SetAcceptanceMask - byte CAN0_SetAcceptanceMask(dword AccMask1, dword AccMask2);
**         SetAcceptanceMode - byte CAN0_SetAcceptanceMode(byte Mode);
**         SendFrame         - byte CAN0_SendFrame(byte BufferNum, dword MessageID, byte FrameType, byte...
**         ReadFrame         - byte CAN0_ReadFrame(dword *MessageID, byte *FrameType, byte *FrameFormat,...
**         GetStateTX        - byte CAN0_GetStateTX(void);
**         GetStateRX        - bool CAN0_GetStateRX(void);
**         GetError          - byte CAN0_GetError(CAN0_TError *Err);
**         SendFrameExt      - byte CAN0_SendFrameExt(dword MessageID, byte FrameType, byte Length, byte...
**
...
#pragma DATA_SEG CAN0_DATA             /* Select data segment "CAN0_DATA" */
#pragma CODE_SEG CAN0_CODE

static bool EnUser;                    /* Enable/Disable CAN */
volatile bool CAN0_EnEvent;            /* Enable/Disable events */
static volatile byte ErrFlag;          /* Error flags mirror of the status register */
static volatile byte SerFlag;          /* Internal driver flags */

/*
** ===================================================================
**     Method      :  CAN0_DisableEvent (component FreescaleCAN)
**
**     Description :
...
*/
/*
byte CAN0_DisableEvent(void)

**  This method is implemented as a macro. See CAN0.h file.  **
*/

/*
** ===================================================================
**     Method      :  CAN0_EnableEvent (component FreescaleCAN)
**
**     Description :
...
/*
** ===================================================================
**     Method      :  CAN0_SetAcceptanceMode (component FreescaleCAN)
**
**     Description :
...
** ===================================================================
*/
byte CAN0_SetAcceptanceMode(byte Mode)
{
...
/*
** ===================================================================
**     Method      :  CAN0_GetStateRX (component FreescaleCAN)
**
**     Description :
...
/*
** ===================================================================
**     Method      :  CAN0_SetAcceptanceCode (component FreescaleCAN)
**
**     Description :
...
** ===================================================================
*/
byte CAN0_SetAcceptanceCode(dword AccCode1, dword AccCode2)
{
  if (!EnUser) {                       /* Is the device disabled by user? */
    return ERR_DISABLED;               /* If yes then error */
  }
...
/*
** ===================================================================
**     Method      :  CAN0_GetError (component FreescaleCAN)
**
**     Description :
...
** ===================================================================
*/
byte CAN0_GetError(CAN0_TError *Err)
{
...
/*
** ===================================================================
**     Method      :  CAN0_SendFrame (component FreescaleCAN)
**
**     Description :
...
** ===================================================================
*/
byte CAN0_SendFrame(byte BufferNum,dword MessageID,byte FrameType,byte Length,const byte *Data)
{
...
/*
** ===================================================================
**     Method      :  CAN0_SendFrameExt (component FreescaleCAN)
**
**     Description :
...
** ===================================================================
*/
byte CAN0_SendFrameExt(dword MessageID,byte FrameType,byte Length,const byte *Data)
{
  byte i;                              /* Temorary variables */
  TMsgBuff *MsgBuff;
  dword tmpId;
...
/*
** ===================================================================
**     Method      :  CAN0_ReadFrame (component FreescaleCAN)
**
**     Description :
...
** ===================================================================
*/
byte CAN0_ReadFrame(dword *MessageID,byte *FrameType,byte *FrameFormat,byte *Length,byte *Data)
{
  byte i;
  dword tmpId = 0U;
...
/*
** ===================================================================
**     Method      :  CAN0_Init (component FreescaleCAN)
**
**     Description :
...
void CAN0_Init(void)
{
  CAN0_EnEvent=FALSE;                  /* Disable events */
...
/*
** ===================================================================
**     Method      :  CAN0_GetStateTX (component FreescaleCAN)
**
**     Description :
...
/*
** ===================================================================
**     Method      :  CAN0_Enable (component FreescaleCAN)
**
**     Description :
...
/*
** ===================================================================
**     Method      :  CAN0_Disable (component FreescaleCAN)
**
**     Description :
...
/*
** ===================================================================
**     Method      :  CAN0_SetAcceptanceMask (component FreescaleCAN)
**
**     Description :
...
** ===================================================================
*/
byte CAN0_SetAcceptanceMask(dword AccMask1, dword AccMask2)
{
  if (!EnUser) {                       /* Is the device disabled by user? */
    return ERR_DISABLED;               /* If yes then error */
  }
...
/*
** ===================================================================
**     Method      :  CAN0_InterruptTx (component FreescaleCAN)
**
**     Description :
...
ISR(CAN0_InterruptTx)
{
  ...
  if (CAN0_EnEvent) {                  /* Are events enabled? */
    CAN0_OnFreeTxBuffer((word)buffer); /* If yes then invoke user event */
  }
}
...
/*
** ===================================================================
**     Method      :  CAN0_InterruptRx (component FreescaleCAN)
**
**     Description :
...
ISR(CAN0_InterruptRx)
{
  ...
  if (CAN0_EnEvent) {                  /* Are events enabled? */
     __DI();
    CAN0_OnFullRxBuffer();             /* If yes then invoke user event. Parameter is always 1 because the CAN module has only one RX message buffer */
  }
...
/*
** ===================================================================
**     Method      :  CAN0_InterruptError (component FreescaleCAN)
**
**     Description :
...
ISR(CAN0_InterruptError)
{
  ...
  if (CAN0_EnEvent) {                  /* Are events enabled? */
    if ((Status & CAN_STATUS_BOFF_MASK) == CAN_STATUS_BOFF_MASK) { /* Is busoff error detected? */
      CAN0_OnBusOff();                 /* If yes then invoke user event */
    } else {
    }
  }
}
