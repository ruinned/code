...
uWord CpuEEIf_GetByte(uWord relative_addr, uByte * p_data)
{
    ...
    rslt = CPUEE_GetByte((far uWord * far)(CALC_ABSOLUTE_ADDR(relative_addr)), p_data);//(*CpuEE_Operation.GetByte)((far uWord * far)(CALC_ABSOLUTE_ADDR(relative_addr)), p_data);    
...
uWord CpuEEIf_SetByte(uWord relative_addr, uByte data)
{
    ...
    rslt = CPUEE_SetByte((far uWord * far)(CALC_ABSOLUTE_ADDR(relative_addr)), data);     
    CPUEEIF_RESTORESTATUSREG();
    return rslt;
}   
...
uWord CpuEEIf_SetWord(uWord relative_addr, uWord data)
{
    ...
    rslt = CPUEE_SetWord((far uWord * far)(CALC_ABSOLUTE_ADDR(relative_addr)), data);    
    CPUEEIF_RESTORESTATUSREG();
    return rslt;
}
...
uWord CpuEEIf_SetLong(uWord relative_addr, uLWord data)
{
    ...
    rslt = CPUEE_SetLong((far uWord * far)(CALC_ABSOLUTE_ADDR(relative_addr)), data);    
    CPUEEIF_RESTORESTATUSREG();
    return rslt;
}  
//************************************************************/
