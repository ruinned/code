...
#define CANSM_MEMMAP_VENDOR_ID  62
#define CANSM_MEMMAP_MODULE_ID  0
#define CANSM_MEMMAP_AR_MAJOR_VERSION  1
#define CANSM_MEMMAP_AR_MINOR_VERSION  1
#define CANSM_MEMMAP_AR_PATCH_VERSION  2
#define CANSM_MEMMAP_SW_MAJOR_VERSION  1
#define CANSM_MEMMAP_SW_MINOR_VERSION  0
#define CANSM_MEMMAP_SW_PATCH_VERSION  0
#define CANSM_MEMMAP_VENDOR_API_INFIX  0
...
#elif defined (CANSM_START_SEC_CODE_FAST)
   #undef      CANSM_START_SEC_CODE_FAST
   #define START_SEC_CODE_FAST
#elif defined (CANSM_STOP_SEC_CODE_FAST)
   #undef      CANSM_STOP_SEC_CODE_FAST
...
#elif defined (CANSM_START_SEC_VAR_FAST_NOINIT_BOOLEAN)
   #undef      CANSM_START_SEC_VAR_FAST_NOINIT_BOOLEAN
   #define START_SEC_VAR_FAST_NOINIT_BOOLEAN
#elif defined (CANSM_STOP_SEC_VAR_FAST_NOINIT_BOOLEAN)
   #undef      CANSM_STOP_SEC_VAR_FAST_NOINIT_BOOLEAN
   #define STOP_SEC_VAR_FAST_NOINIT_BOOLEAN

#elif defined (CANSM_START_SEC_VAR_FAST_NOINIT_8BIT)
   #undef      CANSM_START_SEC_VAR_FAST_NOINIT_8BIT
   #define START_SEC_VAR_FAST_NOINIT_8BIT
#elif defined (CANSM_STOP_SEC_VAR_FAST_NOINIT_8BIT)
   #undef      CANSM_STOP_SEC_VAR_FAST_NOINIT_8BIT
   #define STOP_SEC_VAR_FAST_NOINIT_8BIT

#elif defined (CANSM_START_SEC_VAR_FAST_NOINIT_16BIT)
   #undef      CANSM_START_SEC_VAR_FAST_NOINIT_16BIT
   #define START_SEC_VAR_FAST_NOINIT_16BIT
#elif defined (CANSM_STOP_SEC_VAR_FAST_NOINIT_16BIT)
   #undef      CANSM_STOP_SEC_VAR_FAST_NOINIT_16BIT
   #define STOP_SEC_VAR_FAST_NOINIT_16BIT

#elif defined (CANSM_START_SEC_VAR_FAST_NOINIT_32BIT)
   #undef      CANSM_START_SEC_VAR_FAST_NOINIT_32BIT
   #define START_SEC_VAR_FAST_NOINIT_32BIT
#elif defined (CANSM_STOP_SEC_VAR_FAST_NOINIT_32BIT)
   #undef      CANSM_STOP_SEC_VAR_FAST_NOINIT_32BIT
   #define STOP_SEC_VAR_FAST_NOINIT_32BIT

#elif defined (CANSM_START_SEC_VAR_FAST_NOINIT_UNSPECIFIED)
   #undef      CANSM_START_SEC_VAR_FAST_NOINIT_UNSPECIFIED
   #define START_SEC_VAR_FAST_NOINIT_UNSPECIFIED
#elif defined (CANSM_STOP_SEC_VAR_FAST_NOINIT_UNSPECIFIED)
   #undef      CANSM_STOP_SEC_VAR_FAST_NOINIT_UNSPECIFIED
   #define STOP_SEC_VAR_FAST_NOINIT_UNSPECIFIED

#elif defined (CANSM_START_SEC_VAR_FAST_POWER_ON_INIT_BOOLEAN)
   #undef      CANSM_START_SEC_VAR_FAST_POWER_ON_INIT_BOOLEAN
   #define START_SEC_VAR_FAST_POWER_ON_INIT_BOOLEAN
#elif defined (CANSM_STOP_SEC_VAR_FAST_POWER_ON_INIT_BOOLEAN)
   #undef      CANSM_STOP_SEC_VAR_FAST_POWER_ON_INIT_BOOLEAN
   #define STOP_SEC_VAR_FAST_POWER_ON_INIT_BOOLEAN

#elif defined (CANSM_START_SEC_VAR_FAST_POWER_ON_INIT_8BIT)
   #undef      CANSM_START_SEC_VAR_FAST_POWER_ON_INIT_8BIT
   #define START_SEC_VAR_FAST_POWER_ON_INIT_8BIT
#elif defined (CANSM_STOP_SEC_VAR_FAST_POWER_ON_INIT_8BIT)
   #undef      CANSM_STOP_SEC_VAR_FAST_POWER_ON_INIT_8BIT
   #define STOP_SEC_VAR_FAST_POWER_ON_INIT_8BIT

#elif defined (CANSM_START_SEC_VAR_FAST_POWER_ON_INIT_16BIT)
   #undef      CANSM_START_SEC_VAR_FAST_POWER_ON_INIT_16BIT
   #define START_SEC_VAR_FAST_POWER_ON_INIT_16BIT
#elif defined (CANSM_STOP_SEC_VAR_FAST_POWER_ON_INIT_16BIT)
   #undef      CANSM_STOP_SEC_VAR_FAST_POWER_ON_INIT_16BIT
   #define STOP_SEC_VAR_FAST_POWER_ON_INIT_16BIT

#elif defined (CANSM_START_SEC_VAR_FAST_POWER_ON_INIT_32BIT)
   #undef      CANSM_START_SEC_VAR_FAST_POWER_ON_INIT_32BIT
   #define START_SEC_VAR_FAST_POWER_ON_INIT_32BIT
#elif defined (CANSM_STOP_SEC_VAR_FAST_POWER_ON_INIT_32BIT)
   #undef      CANSM_STOP_SEC_VAR_FAST_POWER_ON_INIT_32BIT
   #define STOP_SEC_VAR_FAST_POWER_ON_INIT_32BIT

#elif defined (CANSM_START_SEC_VAR_FAST_POWER_ON_INIT_UNSPECIFIED)
   #undef      CANSM_START_SEC_VAR_FAST_POWER_ON_INIT_UNSPECIFIED
   #define START_SEC_VAR_FAST_POWER_ON_INIT_UNSPECIFIED
#elif defined (CANSM_STOP_SEC_VAR_FAST_POWER_ON_INIT_UNSPECIFIED)
   #undef      CANSM_STOP_SEC_VAR_FAST_POWER_ON_INIT_UNSPECIFIED
...
#elif defined (CANSM_START_SEC_CONST_FAST_BOOLEAN)
   #undef      CANSM_START_SEC_CONST_FAST_BOOLEAN
   #define START_SEC_CONST_FAST_BOOLEAN
#elif defined (CANSM_STOP_SEC_CONST_FAST_BOOLEAN)
   #undef      CANSM_STOP_SEC_CONST_FAST_BOOLEAN
   #define STOP_SEC_CONST_FAST_BOOLEAN

#elif defined (CANSM_START_SEC_CONST_FAST_8BIT)
   #undef      CANSM_START_SEC_CONST_FAST_8BIT
   #define START_SEC_CONST_FAST_8BIT
#elif defined (CANSM_STOP_SEC_CONST_FAST_8BIT)
   #undef      CANSM_STOP_SEC_CONST_FAST_8BIT
   #define STOP_SEC_CONST_FAST_8BIT

#elif defined (CANSM_START_SEC_CONST_FAST_16BIT)
   #undef      CANSM_START_SEC_CONST_FAST_16BIT
   #define START_SEC_CONST_FAST_16BIT
#elif defined (CANSM_STOP_SEC_CONST_FAST_16BIT)
   #undef      CANSM_STOP_SEC_CONST_FAST_16BIT
   #define STOP_SEC_CONST_FAST_16BIT

#elif defined (CANSM_START_SEC_CONST_FAST_32BIT)
   #undef      CANSM_START_SEC_CONST_FAST_32BIT
   #define START_SEC_CONST_FAST_32BIT
#elif defined (CANSM_STOP_SEC_CONST_FAST_32BIT)
   #undef      CANSM_STOP_SEC_CONST_FAST_32BIT
   #define STOP_SEC_CONST_FAST_32BIT

#elif defined (CANSM_START_SEC_CONST_FAST_UNSPECIFIED)
   #undef      CANSM_START_SEC_CONST_FAST_UNSPECIFIED
   #define START_SEC_CONST_FAST_UNSPECIFIED
#elif defined (CANSM_STOP_SEC_CONST_FAST_UNSPECIFIED)
   #undef      CANSM_STOP_SEC_CONST_FAST_UNSPECIFIED
   #define STOP_SEC_CONST_FAST_UNSPECIFIED

#elif defined (CANSM_START_CONST_PBCFG)
   #undef      CANSM_START_CONST_PBCFG
   #define START_CONST_PBCFG
#elif defined (CANSM_STOP_CONST_PBCFG)
   #undef      CANSM_STOP_CONST_PBCFG
   #define STOP_CONST_PBCFG

#elif defined (CANSM_START_CONST_PBCFG_ROOT)
   #undef      CANSM_START_CONST_PBCFG_ROOT
   #define START_CONST_PBCFG_ROOT
#elif defined (CANSM_STOP_CONST_PBCFG_ROOT)
   #undef      CANSM_STOP_CONST_PBCFG_ROOT
