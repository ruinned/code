...
#define COM_MEMMAP_VENDOR_ID  62
#define COM_MEMMAP_MODULE_ID  0
#define COM_MEMMAP_AR_MAJOR_VERSION  1
#define COM_MEMMAP_AR_MINOR_VERSION  1
#define COM_MEMMAP_AR_PATCH_VERSION  2
#define COM_MEMMAP_SW_MAJOR_VERSION  1
#define COM_MEMMAP_SW_MINOR_VERSION  0
#define COM_MEMMAP_SW_PATCH_VERSION  0
#define COM_MEMMAP_VENDOR_API_INFIX  0
