...
#define CANIF_MEMMAP_VENDOR_ID  62
#define CANIF_MEMMAP_MODULE_ID  0
#define CANIF_MEMMAP_AR_MAJOR_VERSION  1
#define CANIF_MEMMAP_AR_MINOR_VERSION  1
#define CANIF_MEMMAP_AR_PATCH_VERSION  2
#define CANIF_MEMMAP_SW_MAJOR_VERSION  1
#define CANIF_MEMMAP_SW_MINOR_VERSION  0
#define CANIF_MEMMAP_SW_PATCH_VERSION  0
#define CANIF_MEMMAP_VENDOR_API_INFIX  0
...
#elif defined (CANIF_START_SEC_VAR_FAST_NOINIT_BOOLEAN)
   #undef      CANIF_START_SEC_VAR_FAST_NOINIT_BOOLEAN
   #define START_SEC_VAR_FAST_NOINIT_BOOLEAN
#elif defined (CANIF_STOP_SEC_VAR_FAST_NOINIT_BOOLEAN)
   #undef      CANIF_STOP_SEC_VAR_FAST_NOINIT_BOOLEAN
...
#elif defined (CANIF_START_SEC_VAR_FAST_POWER_ON_INIT_8BIT)
   #undef      CANIF_START_SEC_VAR_FAST_POWER_ON_INIT_8BIT
   #define START_SEC_VAR_FAST_POWER_ON_INIT_8BIT
#elif defined (CANIF_STOP_SEC_VAR_FAST_POWER_ON_INIT_8BIT)
   #undef      CANIF_STOP_SEC_VAR_FAST_POWER_ON_INIT_8BIT
   #define STOP_SEC_VAR_FAST_POWER_ON_INIT_8BIT

#elif defined (CANIF_START_SEC_VAR_FAST_POWER_ON_INIT_16BIT)
   #undef      CANIF_START_SEC_VAR_FAST_POWER_ON_INIT_16BIT
   #define START_SEC_VAR_FAST_POWER_ON_INIT_16BIT
#elif defined (CANIF_STOP_SEC_VAR_FAST_POWER_ON_INIT_16BIT)
   #undef      CANIF_STOP_SEC_VAR_FAST_POWER_ON_INIT_16BIT
   #define STOP_SEC_VAR_FAST_POWER_ON_INIT_16BIT

#elif defined (CANIF_START_SEC_VAR_FAST_POWER_ON_INIT_32BIT)
   #undef      CANIF_START_SEC_VAR_FAST_POWER_ON_INIT_32BIT
   #define START_SEC_VAR_FAST_POWER_ON_INIT_32BIT
#elif defined (CANIF_STOP_SEC_VAR_FAST_POWER_ON_INIT_32BIT)
   #undef      CANIF_STOP_SEC_VAR_FAST_POWER_ON_INIT_32BIT
...
#elif defined (CANIF_START_SEC_CONST_FAST_BOOLEAN)
   #undef      CANIF_START_SEC_CONST_FAST_BOOLEAN
   #define START_SEC_CONST_FAST_BOOLEAN
#elif defined (CANIF_STOP_SEC_CONST_FAST_BOOLEAN)
   #undef      CANIF_STOP_SEC_CONST_FAST_BOOLEAN
...
#elif defined (CANIF_START_CONST_PBCFG)
   #undef      CANIF_START_CONST_PBCFG
   #define START_CONST_PBCFG
#elif defined (CANIF_STOP_CONST_PBCFG)
   #undef      CANIF_STOP_CONST_PBCFG
   #define STOP_CONST_PBCFG

#elif defined (CANIF_START_CONST_PBCFG_ROOT)
   #undef      CANIF_START_CONST_PBCFG_ROOT
   #define START_CONST_PBCFG_ROOT
#elif defined (CANIF_STOP_CONST_PBCFG_ROOT)
   #undef      CANIF_STOP_CONST_PBCFG_ROOT
