 ...
 *  V1.0.0       20150413  Huanyu.zhao  Initial version
 */
/*============================================================================*/

/*=======[V E R S I O N  I N F O R M A T I O N]===============================*/
#define PDUR_MEMMAP_VENDOR_ID  62
#define PDUR_MEMMAP_MODULE_ID  0
#define PDUR_MEMMAP_AR_MAJOR_VERSION  1
#define PDUR_MEMMAP_AR_MINOR_VERSION  1
...
#elif defined (PDUR_START_SEC_CODE_FAST)
   #undef      PDUR_START_SEC_CODE_FAST
   #define START_SEC_CODE_FAST
#elif defined (PDUR_STOP_SEC_CODE_FAST)
   #undef      PDUR_STOP_SEC_CODE_FAST
...
#elif defined (PDUR_START_SEC_VAR_FAST_NOINIT_BOOLEAN)
   #undef      PDUR_START_SEC_VAR_FAST_NOINIT_BOOLEAN
   #define START_SEC_VAR_FAST_NOINIT_BOOLEAN
#elif defined (PDUR_STOP_SEC_VAR_FAST_NOINIT_BOOLEAN)
   #undef      PDUR_STOP_SEC_VAR_FAST_NOINIT_BOOLEAN
   #define STOP_SEC_VAR_FAST_NOINIT_BOOLEAN

#elif defined (PDUR_START_SEC_VAR_FAST_NOINIT_8BIT)
   #undef      PDUR_START_SEC_VAR_FAST_NOINIT_8BIT
   #define START_SEC_VAR_FAST_NOINIT_8BIT
#elif defined (PDUR_STOP_SEC_VAR_FAST_NOINIT_8BIT)
   #undef      PDUR_STOP_SEC_VAR_FAST_NOINIT_8BIT
   #define STOP_SEC_VAR_FAST_NOINIT_8BIT

#elif defined (PDUR_START_SEC_VAR_FAST_NOINIT_16BIT)
   #undef      PDUR_START_SEC_VAR_FAST_NOINIT_16BIT
   #define START_SEC_VAR_FAST_NOINIT_16BIT
#elif defined (PDUR_STOP_SEC_VAR_FAST_NOINIT_16BIT)
   #undef      PDUR_STOP_SEC_VAR_FAST_NOINIT_16BIT
   #define STOP_SEC_VAR_FAST_NOINIT_16BIT

#elif defined (PDUR_START_SEC_VAR_FAST_NOINIT_32BIT)
   #undef      PDUR_START_SEC_VAR_FAST_NOINIT_32BIT
   #define START_SEC_VAR_FAST_NOINIT_32BIT
#elif defined (PDUR_STOP_SEC_VAR_FAST_NOINIT_32BIT)
   #undef      PDUR_STOP_SEC_VAR_FAST_NOINIT_32BIT
...
#elif defined (PDUR_START_SEC_VAR_FAST_POWER_ON_INIT_BOOLEAN)
   #undef      PDUR_START_SEC_VAR_FAST_POWER_ON_INIT_BOOLEAN
   #define START_SEC_VAR_FAST_POWER_ON_INIT_BOOLEAN
#elif defined (PDUR_STOP_SEC_VAR_FAST_POWER_ON_INIT_BOOLEAN)
   #undef      PDUR_STOP_SEC_VAR_FAST_POWER_ON_INIT_BOOLEAN
   #define STOP_SEC_VAR_FAST_POWER_ON_INIT_BOOLEAN

#elif defined (PDUR_START_SEC_VAR_FAST_POWER_ON_INIT_8BIT)
   #undef      PDUR_START_SEC_VAR_FAST_POWER_ON_INIT_8BIT
   #define START_SEC_VAR_FAST_POWER_ON_INIT_8BIT
#elif defined (PDUR_STOP_SEC_VAR_FAST_POWER_ON_INIT_8BIT)
   #undef      PDUR_STOP_SEC_VAR_FAST_POWER_ON_INIT_8BIT
   #define STOP_SEC_VAR_FAST_POWER_ON_INIT_8BIT

#elif defined (PDUR_START_SEC_VAR_FAST_POWER_ON_INIT_16BIT)
   #undef      PDUR_START_SEC_VAR_FAST_POWER_ON_INIT_16BIT
   #define START_SEC_VAR_FAST_POWER_ON_INIT_16BIT
#elif defined (PDUR_STOP_SEC_VAR_FAST_POWER_ON_INIT_16BIT)
   #undef      PDUR_STOP_SEC_VAR_FAST_POWER_ON_INIT_16BIT
   #define STOP_SEC_VAR_FAST_POWER_ON_INIT_16BIT

#elif defined (PDUR_START_SEC_VAR_FAST_POWER_ON_INIT_32BIT)
   #undef      PDUR_START_SEC_VAR_FAST_POWER_ON_INIT_32BIT
   #define START_SEC_VAR_FAST_POWER_ON_INIT_32BIT
#elif defined (PDUR_STOP_SEC_VAR_FAST_POWER_ON_INIT_32BIT)
   #undef      PDUR_STOP_SEC_VAR_FAST_POWER_ON_INIT_32BIT
   #define STOP_SEC_VAR_FAST_POWER_ON_INIT_32BIT

#elif defined (PDUR_START_SEC_VAR_FAST_POWER_ON_INIT_UNSPECIFIED)
   #undef      PDUR_START_SEC_VAR_FAST_POWER_ON_INIT_UNSPECIFIED
   #define START_SEC_VAR_FAST_POWER_ON_INIT_UNSPECIFIED
#elif defined (PDUR_STOP_SEC_VAR_FAST_POWER_ON_INIT_UNSPECIFIED)
   #undef      PDUR_STOP_SEC_VAR_FAST_POWER_ON_INIT_UNSPECIFIED
...
#elif defined (PDUR_START_SEC_CONST_FAST_BOOLEAN)
   #undef      PDUR_START_SEC_CONST_FAST_BOOLEAN
   #define START_SEC_CONST_FAST_BOOLEAN
#elif defined (PDUR_STOP_SEC_CONST_FAST_BOOLEAN)
   #undef      PDUR_STOP_SEC_CONST_FAST_BOOLEAN
   #define STOP_SEC_CONST_FAST_BOOLEAN

#elif defined (PDUR_START_SEC_CONST_FAST_8BIT)
   #undef      PDUR_START_SEC_CONST_FAST_8BIT
   #define START_SEC_CONST_FAST_8BIT
#elif defined (PDUR_STOP_SEC_CONST_FAST_8BIT)
   #undef      PDUR_STOP_SEC_CONST_FAST_8BIT
   #define STOP_SEC_CONST_FAST_8BIT

#elif defined (PDUR_START_SEC_CONST_FAST_16BIT)
   #undef      PDUR_START_SEC_CONST_FAST_16BIT
   #define START_SEC_CONST_FAST_16BIT
#elif defined (PDUR_STOP_SEC_CONST_FAST_16BIT)
   #undef      PDUR_STOP_SEC_CONST_FAST_16BIT
   #define STOP_SEC_CONST_FAST_16BIT

#elif defined (PDUR_START_SEC_CONST_FAST_32BIT)
   #undef      PDUR_START_SEC_CONST_FAST_32BIT
   #define START_SEC_CONST_FAST_32BIT
#elif defined (PDUR_STOP_SEC_CONST_FAST_32BIT)
   #undef      PDUR_STOP_SEC_CONST_FAST_32BIT
   #define STOP_SEC_CONST_FAST_32BIT

#elif defined (PDUR_START_SEC_CONST_FAST_UNSPECIFIED)
   #undef      PDUR_START_SEC_CONST_FAST_UNSPECIFIED
   #define START_SEC_CONST_FAST_UNSPECIFIED
#elif defined (PDUR_STOP_SEC_CONST_FAST_UNSPECIFIED)
   #undef      PDUR_STOP_SEC_CONST_FAST_UNSPECIFIED
   #define STOP_SEC_CONST_FAST_UNSPECIFIED

#elif defined (PDUR_START_CONST_PBCFG)
   #undef      PDUR_START_CONST_PBCFG
   #define START_CONST_PBCFG
#elif defined (PDUR_STOP_CONST_PBCFG)
   #undef      PDUR_STOP_CONST_PBCFG
   #define STOP_CONST_PBCFG

#elif defined (PDUR_START_CONST_PBCFG_ROOT)
   #undef      PDUR_START_CONST_PBCFG_ROOT
   #define START_CONST_PBCFG_ROOT
#elif defined (PDUR_STOP_CONST_PBCFG_ROOT)
   #undef      PDUR_STOP_CONST_PBCFG_ROOT
