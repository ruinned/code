 ...
 *
 *  <DEMpiler: CodeWarriar    MCU:MC9S12>
 *
 *  @author     <chen xue hua>
 *  @date       <2013-02-27>
 */
...
#define DEM_MEMMAP_MODULE_ID  0
#define DEM_MEMMAP_AR_MAJOR_VERSION  1
#define DEM_MEMMAP_AR_MINOR_VERSION  1
...
#define DEM_MEMMAP_VENDOR_API_INFIX  0
...
#elif defined (DEM_START_SEC_VAR_FAST_NOINIT_BOOLEAN)
   #undef      DEM_START_SEC_VAR_FAST_NOINIT_BOOLEAN
   #define START_SEC_VAR_FAST_NOINIT_BOOLEAN
#elif defined (DEM_STOP_SEC_VAR_FAST_NOINIT_BOOLEAN)
   #undef      DEM_STOP_SEC_VAR_FAST_NOINIT_BOOLEAN
   #define STOP_SEC_VAR_FAST_NOINIT_BOOLEAN

#elif defined (DEM_START_SEC_VAR_FAST_NOINIT_8BIT)
   #undef      DEM_START_SEC_VAR_FAST_NOINIT_8BIT
   #define START_SEC_VAR_FAST_NOINIT_8BIT
#elif defined (DEM_STOP_SEC_VAR_FAST_NOINIT_8BIT)
   #undef      DEM_STOP_SEC_VAR_FAST_NOINIT_8BIT
   #define STOP_SEC_VAR_FAST_NOINIT_8BIT

#elif defined (DEM_START_SEC_VAR_FAST_NOINIT_16BIT)
   #undef      DEM_START_SEC_VAR_FAST_NOINIT_16BIT
   #define START_SEC_VAR_FAST_NOINIT_16BIT
#elif defined (DEM_STOP_SEC_VAR_FAST_NOINIT_16BIT)
   #undef      DEM_STOP_SEC_VAR_FAST_NOINIT_16BIT
   #define STOP_SEC_VAR_FAST_NOINIT_16BIT

#elif defined (DEM_START_SEC_VAR_FAST_NOINIT_32BIT)
   #undef      DEM_START_SEC_VAR_FAST_NOINIT_32BIT
   #define START_SEC_VAR_FAST_NOINIT_32BIT
#elif defined (DEM_STOP_SEC_VAR_FAST_NOINIT_32BIT)
   #undef      DEM_STOP_SEC_VAR_FAST_NOINIT_32BIT
   #define STOP_SEC_VAR_FAST_NOINIT_32BIT

#elif defined (DEM_START_SEC_VAR_FAST_NOINIT_UNSPECIFIED)
   #undef      DEM_START_SEC_VAR_FAST_NOINIT_UNSPECIFIED
   #define START_SEC_VAR_FAST_NOINIT_UNSPECIFIED
#elif defined (DEM_STOP_SEC_VAR_FAST_NOINIT_UNSPECIFIED)
   #undef      DEM_STOP_SEC_VAR_FAST_NOINIT_UNSPECIFIED
...
#elif defined (DEM_START_SEC_VAR_FAST_POWER_ON_INIT_8BIT)
   #undef      DEM_START_SEC_VAR_FAST_POWER_ON_INIT_8BIT
   #define START_SEC_VAR_FAST_POWER_ON_INIT_8BIT
#elif defined (DEM_STOP_SEC_VAR_FAST_POWER_ON_INIT_8BIT)
   #undef      DEM_STOP_SEC_VAR_FAST_POWER_ON_INIT_8BIT
   #define STOP_SEC_VAR_FAST_POWER_ON_INIT_8BIT

#elif defined (DEM_START_SEC_VAR_FAST_POWER_ON_INIT_16BIT)
   #undef      DEM_START_SEC_VAR_FAST_POWER_ON_INIT_16BIT
   #define START_SEC_VAR_FAST_POWER_ON_INIT_16BIT
#elif defined (DEM_STOP_SEC_VAR_FAST_POWER_ON_INIT_16BIT)
   #undef      DEM_STOP_SEC_VAR_FAST_POWER_ON_INIT_16BIT
   #define STOP_SEC_VAR_FAST_POWER_ON_INIT_16BIT

#elif defined (DEM_START_SEC_VAR_FAST_POWER_ON_INIT_32BIT)
   #undef      DEM_START_SEC_VAR_FAST_POWER_ON_INIT_32BIT
   #define START_SEC_VAR_FAST_POWER_ON_INIT_32BIT
#elif defined (DEM_STOP_SEC_VAR_FAST_POWER_ON_INIT_32BIT)
   #undef      DEM_STOP_SEC_VAR_FAST_POWER_ON_INIT_32BIT
...
#elif defined (DEM_START_SEC_CONST_FAST_BOOLEAN)
   #undef      DEM_START_SEC_CONST_FAST_BOOLEAN
   #define START_SEC_CONST_FAST_BOOLEAN
#elif defined (DEM_STOP_SEC_CONST_FAST_BOOLEAN)
   #undef      DEM_STOP_SEC_CONST_FAST_BOOLEAN
   #define STOP_SEC_CONST_FAST_BOOLEAN

#elif defined (DEM_START_SEC_CONST_FAST_8BIT)
   #undef      DEM_START_SEC_CONST_FAST_8BIT
   #define START_SEC_CONST_FAST_8BIT
#elif defined (DEM_STOP_SEC_CONST_FAST_8BIT)
   #undef      DEM_STOP_SEC_CONST_FAST_8BIT
   #define STOP_SEC_CONST_FAST_8BIT

#elif defined (DEM_START_SEC_CONST_FAST_16BIT)
   #undef      DEM_START_SEC_CONST_FAST_16BIT
   #define START_SEC_CONST_FAST_16BIT
#elif defined (DEM_STOP_SEC_CONST_FAST_16BIT)
   #undef      DEM_STOP_SEC_CONST_FAST_16BIT
   #define STOP_SEC_CONST_FAST_16BIT

#elif defined (DEM_START_SEC_CONST_FAST_32BIT)
   #undef      DEM_START_SEC_CONST_FAST_32BIT
   #define START_SEC_CONST_FAST_32BIT
#elif defined (DEM_STOP_SEC_CONST_FAST_32BIT)
   #undef      DEM_STOP_SEC_CONST_FAST_32BIT
   #define STOP_SEC_CONST_FAST_32BIT

#elif defined (DEM_START_SEC_CONST_FAST_UNSPECIFIED)
   #undef      DEM_START_SEC_CONST_FAST_UNSPECIFIED
   #define START_SEC_CONST_FAST_UNSPECIFIED
#elif defined (DEM_STOP_SEC_CONST_FAST_UNSPECIFIED)
   #undef      DEM_STOP_SEC_CONST_FAST_UNSPECIFIED
   #define STOP_SEC_CONST_FAST_UNSPECIFIED

#elif defined (DEM_START_CONST_PBCFG)
   #undef      DEM_START_CONST_PBCFG
   #define START_CONST_PBCFG
#elif defined (DEM_STOP_CONST_PBCFG)
   #undef      DEM_STOP_CONST_PBCFG
   #define STOP_CONST_PBCFG

#elif defined (DEM_START_CONST_PBCFG_ROOT)
   #undef      DEM_START_CONST_PBCFG_ROOT
   #define START_CONST_PBCFG_ROOT
#elif defined (DEM_STOP_CONST_PBCFG_ROOT)
   #undef      DEM_STOP_CONST_PBCFG_ROOT
