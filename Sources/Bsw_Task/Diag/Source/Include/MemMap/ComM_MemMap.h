...
#define COMM_MEMMAP_MODULE_ID  0u
#define COMM_MEMMAP_AR_MAJOR_VERSION  1u
...
#elif defined (COMM_START_SEC_VAR_FAST_NOINIT_BOOLEAN)
   #undef      COMM_START_SEC_VAR_FAST_NOINIT_BOOLEAN
   #define START_SEC_VAR_FAST_NOINIT_BOOLEAN
#elif defined (COMM_STOP_SEC_VAR_FAST_NOINIT_BOOLEAN)
   #undef      COMM_STOP_SEC_VAR_FAST_NOINIT_BOOLEAN
   #define STOP_SEC_VAR_FAST_NOINIT_BOOLEAN

#elif defined (COMM_START_SEC_VAR_FAST_NOINIT_8BIT)
   #undef      COMM_START_SEC_VAR_FAST_NOINIT_8BIT
   #define START_SEC_VAR_FAST_NOINIT_8BIT
#elif defined (COMM_STOP_SEC_VAR_FAST_NOINIT_8BIT)
   #undef      COMM_STOP_SEC_VAR_FAST_NOINIT_8BIT
   #define STOP_SEC_VAR_FAST_NOINIT_8BIT

#elif defined (COMM_START_SEC_VAR_FAST_NOINIT_16BIT)
   #undef      COMM_START_SEC_VAR_FAST_NOINIT_16BIT
   #define START_SEC_VAR_FAST_NOINIT_16BIT
#elif defined (COMM_STOP_SEC_VAR_FAST_NOINIT_16BIT)
   #undef      COMM_STOP_SEC_VAR_FAST_NOINIT_16BIT
   #define STOP_SEC_VAR_FAST_NOINIT_16BIT

#elif defined (COMM_START_SEC_VAR_FAST_NOINIT_32BIT)
   #undef      COMM_START_SEC_VAR_FAST_NOINIT_32BIT
   #define START_SEC_VAR_FAST_NOINIT_32BIT
#elif defined (COMM_STOP_SEC_VAR_FAST_NOINIT_32BIT)
   #undef      COMM_STOP_SEC_VAR_FAST_NOINIT_32BIT
   #define STOP_SEC_VAR_FAST_NOINIT_32BIT

#elif defined (COMM_START_SEC_VAR_FAST_NOINIT_UNSPECIFIED)
   #undef      COMM_START_SEC_VAR_FAST_NOINIT_UNSPECIFIED
   #define START_SEC_VAR_FAST_NOINIT_UNSPECIFIED
#elif defined (COMM_STOP_SEC_VAR_FAST_NOINIT_UNSPECIFIED)
   #undef      COMM_STOP_SEC_VAR_FAST_NOINIT_UNSPECIFIED
...
#elif defined (COMM_START_SEC_VAR_FAST_POWER_ON_INIT_8BIT)
   #undef      COMM_START_SEC_VAR_FAST_POWER_ON_INIT_8BIT
   #define START_SEC_VAR_FAST_POWER_ON_INIT_8BIT
#elif defined (COMM_STOP_SEC_VAR_FAST_POWER_ON_INIT_8BIT)
   #undef      COMM_STOP_SEC_VAR_FAST_POWER_ON_INIT_8BIT
   #define STOP_SEC_VAR_FAST_POWER_ON_INIT_8BIT

#elif defined (COMM_START_SEC_VAR_FAST_POWER_ON_INIT_16BIT)
   #undef      COMM_START_SEC_VAR_FAST_POWER_ON_INIT_16BIT
   #define START_SEC_VAR_FAST_POWER_ON_INIT_16BIT
#elif defined (COMM_STOP_SEC_VAR_FAST_POWER_ON_INIT_16BIT)
   #undef      COMM_STOP_SEC_VAR_FAST_POWER_ON_INIT_16BIT
   #define STOP_SEC_VAR_FAST_POWER_ON_INIT_16BIT

#elif defined (COMM_START_SEC_VAR_FAST_POWER_ON_INIT_32BIT)
   #undef      COMM_START_SEC_VAR_FAST_POWER_ON_INIT_32BIT
   #define START_SEC_VAR_FAST_POWER_ON_INIT_32BIT
#elif defined (COMM_STOP_SEC_VAR_FAST_POWER_ON_INIT_32BIT)
   #undef      COMM_STOP_SEC_VAR_FAST_POWER_ON_INIT_32BIT
...
#elif defined (COMM_START_SEC_CONST_FAST_BOOLEAN)
   #undef      COMM_START_SEC_CONST_FAST_BOOLEAN
   #define START_SEC_CONST_FAST_BOOLEAN
#elif defined (COMM_STOP_SEC_CONST_FAST_BOOLEAN)
   #undef      COMM_STOP_SEC_CONST_FAST_BOOLEAN
   #define STOP_SEC_CONST_FAST_BOOLEAN

#elif defined (COMM_START_SEC_CONST_FAST_8BIT)
   #undef      COMM_START_SEC_CONST_FAST_8BIT
   #define START_SEC_CONST_FAST_8BIT
#elif defined (COMM_STOP_SEC_CONST_FAST_8BIT)
   #undef      COMM_STOP_SEC_CONST_FAST_8BIT
   #define STOP_SEC_CONST_FAST_8BIT

#elif defined (COMM_START_SEC_CONST_FAST_16BIT)
   #undef      COMM_START_SEC_CONST_FAST_16BIT
   #define START_SEC_CONST_FAST_16BIT
#elif defined (COMM_STOP_SEC_CONST_FAST_16BIT)
   #undef      COMM_STOP_SEC_CONST_FAST_16BIT
   #define STOP_SEC_CONST_FAST_16BIT

#elif defined (COMM_START_SEC_CONST_FAST_32BIT)
   #undef      COMM_START_SEC_CONST_FAST_32BIT
   #define START_SEC_CONST_FAST_32BIT
#elif defined (COMM_STOP_SEC_CONST_FAST_32BIT)
   #undef      COMM_STOP_SEC_CONST_FAST_32BIT
   #define STOP_SEC_CONST_FAST_32BIT

#elif defined (COMM_START_SEC_CONST_FAST_UNSPECIFIED)
   #undef      COMM_START_SEC_CONST_FAST_UNSPECIFIED
   #define START_SEC_CONST_FAST_UNSPECIFIED
#elif defined (COMM_STOP_SEC_CONST_FAST_UNSPECIFIED)
   #undef      COMM_STOP_SEC_CONST_FAST_UNSPECIFIED
   #define STOP_SEC_CONST_FAST_UNSPECIFIED

#elif defined (COMM_START_CONST_PBCFG)
   #undef      COMM_START_CONST_PBCFG
   #define START_CONST_PBCFG
#elif defined (COMM_STOP_CONST_PBCFG)
   #undef      COMM_STOP_CONST_PBCFG
   #define STOP_CONST_PBCFG

#elif defined (COMM_START_CONST_PBCFG_ROOT)
   #undef      COMM_START_CONST_PBCFG_ROOT
   #define START_CONST_PBCFG_ROOT
#elif defined (COMM_STOP_CONST_PBCFG_ROOT)
   #undef      COMM_STOP_CONST_PBCFG_ROOT
