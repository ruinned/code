...
#define OS_MEMMAP_VENDOR_ID  62
#define OS_MEMMAP_MODULE_ID  0
#define OS_MEMMAP_AR_MAJOR_VERSION  1
#define OS_MEMMAP_AR_MINOR_VERSION  1
#define OS_MEMMAP_AR_PATCH_VERSION  2
#define OS_MEMMAP_SW_MAJOR_VERSION  1
#define OS_MEMMAP_SW_MINOR_VERSION  0
#define OS_MEMMAP_SW_PATCH_VERSION  0
#define OS_MEMMAP_VENDOR_API_INFIX  0
...
#pragma CODE_SEG DEFAULT
#elif defined (OS_START_SEC_CODE_VECTOR)
   #undef      OS_START_SEC_CODE_VECTOR
   #define START_SEC_CODE_VECTOR
#elif defined (OS_STOP_SEC_CODE_VECTOR)
   #undef      OS_STOP_SEC_CODE_VECTOR
   #define STOP_SEC_CODE_VECTOR
   
#elif defined (OS_START_SEC_VAR_STACK)
   #undef      OS_START_SEC_VAR_STACK
   #pragma DATA_SEG .__os_stack
   ...
   #pragma CONST_SEG .__os_int_vector
